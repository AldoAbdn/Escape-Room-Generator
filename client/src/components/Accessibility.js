...
class Accessibility extends Component {
    ...
    handleVisualChange = (event) => {
        ...
        state.visual[event.target.id] = event.target.checked;
    ...
    handlePhysicalChange = (event) => {
        var state = {...this.props.accessibility};
        state.physical[event.target.id] = event.target.checked;
        this.props.updateAccessibility(state);
    }
                        ...
                        <Row>
                            <Col>
                                <Card>
                                    ...
                                    <Row>
                                        <Col xs="8"><CustomInput type="checkbox" name="protanomaly" id="protanomaly" label="Protanomaly" checked={this.props.accessibility.visual.protanomaly} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><CustomInput type="checkbox" name="protanopia" id="protanopia" label="Protanopia" checked={this.props.accessibility.visual.protanopia} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><CustomInput type="checkbox" name="deuteranomaly" id="deuteranomaly" label="Deuteranomaly" checked={this.props.accessibility.visual.deuteranomaly} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><CustomInput type="checkbox" name="deuteranopia" id="deuteranopia" label="Deuteranopia" checked={this.props.accessibility.visual.deuteranopia} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><CustomInput type="checkbox" name="tritanomaly" id="tritanomaly" label="Tritanomaly" checked={this.props.accessibility.visual.tritanomaly} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><CustomInput type="checkbox" name="tritanopia" id="tritanopia" label="Tritanopia" checked={this.props.accessibility.visual.tritanopia} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><CustomInput type="checkbox" name="coneMonochromacy" id="coneMonochromacy" label="Cone Monochromacy" checked={this.props.accessibility.visual.coneMonochromacy} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><CustomInput type="checkbox" name="rodMonochromacy" id="rodMonochromacy" label="Rod Monochromacy" checked={this.props.accessibility.visual.rodMonochromacy} onChange={this.handleVisualChange}/></Col>
                            ...
                            <Col>
                                <Card>
                                    <Row>
                                        <Col xs="8"><CustomInput type="checkbox" name="largeFonts" id="largeFonts" label="Large Fonts" checked={this.props.accessibility.visual.largeFonts} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><CustomInput type="checkbox" name="highContrast" id="highContrast" label="High Contrast" checked={this.props.accessibility.visual.highContrast} onChange={this.handleVisualChange}/></Col>
                    ...
                    <Col>
                        ...
                        <Row>
                            <Col>
                                <Card>
                                    <Row>
                                        <Col xs="8"> <CustomInput type="checkbox" name="wheelchairAccessible" id="wheelchairAccessible" label="Wheelchair Accessible" checked={this.props.accessibility.physical.wheelchairAccessible} onChange={this.handlePhysicalChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><CustomInput type="checkbox" name="motorAccessible" id="motorAccessible" label="Accessible for players with motor function issues" checked={this.props.accessibility.physical.motorAccessible} onChange={this.handlePhysicalChange}/></Col>
