...
import { Container, Row, Col, Card, Input, UncontrolledTooltip } from 'reactstrap';
                        ...
                        <Row>
                            <Col>
                                <Card>
                                    ...
                                    <Row>
                                        <Col xs="8"><Input type="checkbox" name="protanomaly" id="protanomaly" label="Protanomaly" value={this.props.accessibility.visual.protanomaly} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><Input type="checkbox" name="protanopia" id="protanopia" label="Protanopia" value={this.props.accessibility.visual.protanopia} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><Input type="checkbox" name="deuteranomaly" id="deuteranomaly" label="Deuteranomaly" value={this.props.accessibility.visual.deuteranomaly} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><Input type="checkbox" name="deuteranopia" id="deuteranopia" label="Deuteranopia" value={this.props.accessibility.visual.deuteranopia} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><Input type="checkbox" name="tritanomaly" id="tritanomaly" label="Tritanomaly" value={this.props.accessibility.visual.tritanomaly} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><Input type="checkbox" name="tritanopia" id="tritanopia" label="Tritanopia" value={this.props.accessibility.visual.tritanopia} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><Input type="checkbox" name="coneMonochromacy" id="coneMonochromacy" label="Cone Monochromacy" value={this.props.accessibility.visual.coneMonochromacy} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><Input type="checkbox" name="rodMonochromacy" id="rodMonochromacy" label="Rod Monochromacy" value={this.props.accessibility.visual.rodMonochromacy} onChange={this.handleVisualChange}/></Col>
                            ...
                            <Col>
                                <Card>
                                    <Row>
                                        <Col xs="8"><Input type="checkbox" name="largeFonts" id="largeFonts" label="Large Fonts" value={this.props.accessibility.visual.largeFonts} onChange={this.handleVisualChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><Input type="checkbox" name="highContrast" id="highContrast" label="High Contrast" value={this.props.accessibility.visual.highContrast} onChange={this.handleVisualChange}/></Col>
                    ...
                    <Col>
                        ...
                        <Row>
                            <Col>
                                <Card>
                                    <Row>
                                        <Col xs="8"> <Input type="checkbox" name="wheelchairAccessible" id="wheelchairAccessible" label="Wheelchair Accessible" value={this.props.accessibility.physical.wheelchairAccessible} onChange={this.handlePhysicalChange}/></Col>
                                    ...
                                    <Row>
                                        <Col xs="8"><Input type="checkbox" name="motorAccessible" id="motorAccessible" label="Accessible for players with motor function issues" value={this.props.accessibility.physical.motorAccessible} onChange={this.handlePhysicalChange}/></Col>
