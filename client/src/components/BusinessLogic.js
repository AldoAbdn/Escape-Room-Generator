    ...
    render() {
        ...
        return (
            <Switch>
                ...
                <ConditionalRoute path="/runner" condition={Object.keys(escapeRoom).length > 0 && escapeRoom!==undefined && loggedIn} redirect={'/'} render={(routeProps) =>(<EscapeRoomRunner name={escapeRoom.details.name} time={parseInt(escapeRoom.details.targetTime)} background="/images/backgrounds/main.jpg" hint="/sounds/hint.wav"/>)}/>
