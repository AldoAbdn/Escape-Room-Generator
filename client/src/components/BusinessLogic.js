    ...
    render() {
        ...
        return (
            <Switch>
                ...
                <ConditionalRoute path="/runner" condition={Object.keys(escapeRoom).length > 0 && escapeRoom!==undefined && loggedIn} redirect={'/'} render={(routeProps) =>(<EscapeRoomRunner name={escapeRoom.details.name} time={parseInt(escapeRoom.details.targetTime)} background="/images/backgrounds/main.jpg" music="https://cdn.bensound.com/bensound-wildwildtown.mp3" hint="/sounds/hint.wav"/>)}/>
