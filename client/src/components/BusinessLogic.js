    ...
    render() {
        ...
        return (
            <Switch>
                ...
                <ConditionalRoute path="/runner" condition={Object.keys(escapeRoom).length > 0 && escapeRoom!==undefined && loggedIn} redirect={'/'} render={(routeProps) =>(<EscapeRoomRunner escapeRoom={escapeRoom}/>)}/>
